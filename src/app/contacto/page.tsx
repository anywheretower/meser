        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              ...
              <h2 className="mt-4 text-lg font-semibold text-navy group-hover:text-green-600 transition-colors">
                WhatsApp
              </h2>
              <p className="mt-1 text-sm text-steel-dark">
                Respuesta inmediata. Escríbenos directo.
              </p>
            ...
            >
              ...
              <h2 className="mt-4 text-lg font-semibold text-navy group-hover:text-cyan transition-colors">
                Teléfono
              </h2>
              <p className="mt-1 text-sm text-steel-dark">
                Habla directo con el dueño de Meser.
              </p>
            ...
            <div className="rounded-2xl border border-gray-200 p-8">
              ...
              <p className="mt-3 text-sm font-medium text-navy">
                Los Militares 5620, Of. 905
              </p>
              <p className="text-sm text-steel-dark">Las Condes, Santiago</p>
            </div>
          </div>
