...
export default function Home() {
  return (
    <>
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 animate-fade-in-up stagger-4 whitespace-nowrap">
              <WhatsAppLink
                ...
                location="hero-home"
                className="group inline-flex items-center justify-center rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#1ebe57] transition-all shadow-lg shadow-green-500/20"
              >
                <svg className="mr-1.5 w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-steel-dark mt-0.5">Samsung, Midea y Anwo desde $319.990</p>
              </div>
            </Link>
            <Link
              href="/termos"
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                text: "Canaletas ocultas, sin cables a la vista. Tu hogar sigue perfecto.",
              },
              {
                icon: (
                  <path
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <RevealOnScroll key={item.step} delay={i * 0.15} className="relative">
                ...
                <span className="inline-block mt-1 text-xs font-semibold text-cyan uppercase tracking-wider">
                  {item.subtitle}
                </span>
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <RevealOnScroll key={i} delay={i * 0.15} className="relative p-8">
                ...
                <blockquote className="mt-4 text-sm text-navy/75 leading-relaxed">
                  {testimonial.quote}
                </blockquote>
      ...
      {/* G39: Review schema individual para testimonios */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            {
              "@context": "https://schema.org",
              "@type": "Review",
              itemReviewed: { "@type": "HVACBusiness", "@id": "https://www.meser.cl/#localbusiness" },
              author: { "@type": "Person", name: "María González" },
              reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
              reviewBody: "El diagnóstico por Zoom fue clave. En 25 minutos entendí exactamente qué necesitaba y cuánto iba a costar. La instalación quedó impecable — ni se notan los tubos.",
            },
            {
              "@context": "https://schema.org",
              "@type": "Review",
              itemReviewed: { "@type": "HVACBusiness", "@id": "https://www.meser.cl/#localbusiness" },
              author: { "@type": "Person", name: "Rodrigo Fernández" },
              reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
              reviewBody: "Coticé en tres empresas y en todas me daban un precio por el equipo y otro por la instalación, con 'extras' que aparecían después. En Meser el precio fue uno solo y no cambió.",
            },
            {
              "@context": "https://schema.org",
              "@type": "Review",
              itemReviewed: { "@type": "HVACBusiness", "@id": "https://www.meser.cl/#localbusiness" },
              author: { "@type": "Person", name: "Carolina Muñoz" },
              reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
              reviewBody: "Lo que más me gustó es que hablé directo con el dueño. No un vendedor, no un call center. El mismo dueño me asesoró y se aseguró de que todo quedara perfecto.",
            },
          ]),
        }}
      />
