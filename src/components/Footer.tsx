...
const footerLinks = {
  ...
  soluciones: [
    { href: "/soluciones/departamento", label: "Departamentos" },
    { href: "/soluciones/casa", label: "Casas" },
    { href: "/soluciones/mansarda", label: "Mansardas" },
    { href: "/soluciones/oficina", label: "Oficinas" },
  ],
  empresa: [
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <span className="text-2xl font-bold">meser</span>
            <p className="mt-3 text-sm text-steel-light leading-relaxed">
              Climatización integral para tu hogar en Santiago. Diagnóstico
              gratuito, precio cerrado, instalación estética.
            </p>
            ...
            <div className="mt-4 space-y-2">
              <PhoneLink
                ...
                location="footer"
                className="flex items-center gap-2 text-sm text-steel-light hover:text-cyan transition-colors"
              >
              ...
              <p className="flex items-start gap-2 text-sm text-steel-light">
            ...
            <div className="mt-4 flex items-center gap-3">
              <a
                href="https://www.facebook.com/profile.php?id=61575725826039"
                target="_blank"
              ...
              <a
                href="https://instagram.com/meser_spa"
                target="_blank"
                rel="noopener noreferrer"
                className="text-steel-light hover:text-cyan transition-colors"
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-steel">
            <span>Cobertura: Toda la Región Metropolitana</span>
            <span className="hidden sm:inline">·</span>
            <span>Pago seguro con Transbank</span>
          </div>
        </div>
      </div>
    </footer>
